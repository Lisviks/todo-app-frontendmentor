...
const MongooseAdapter = (dbConnect: Promise<Mongoose>, models?: MongooseAdapterModels): Adapter => {
  // Load Backup Models
  ...
  const VerificationToken: Model<AdapterVerificationToken> = mongoose.models.VerificationToken;
